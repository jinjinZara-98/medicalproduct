...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 997901658L;
    ...
    public final EnumPath<capstonedesign.medicalproduct.domain.OrderStatus> status = createEnum("status", capstonedesign.medicalproduct.domain.OrderStatus.class);
