...
public class ReviewFactory extends BasicFactory {
    ...
    public static List<ReviewDto> makeReviewDtoList() {
        ReviewDto reviewDto = new ReviewDto(1L, "홍길동", 1L, "수술가운", "http://www.yolomarket.kr/data/item/G171103/thumb-4A06002040_L_250x250.jpg"
